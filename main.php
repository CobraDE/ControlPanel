          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="main.php?site=settings"><i class="fa fa-circle-o"></i> Einstellungen</a></li>
              </ul>
            </li>
			<li class="treeview">
              <a href="#">
            ...
            <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Impressum</span></a></li>
            <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Kontakt</span></a></li>
			<?php 
				if($o_main->isProjektleitung($_SESSION["acc"])){
					echo "
						<li class='header'>Adminbereich</li>
						<li><a href='main.php?site=admin'><i class='fa fa-circle-o text-red'></i> <span>Administration</span></a></li>
					";
				}
			?>
          </ul>
